...
function injectInsolvencyUpgrade(body){
  ...
  if(!body.includes('/paperless-inbox-filter-v154.js')) tags.push('<script src="/paperless-inbox-filter-v154.js?v=154" defer></script>');
  ...
  if(!body.includes('/ui-fix-v154.js')) tags.push('<script src="/ui-fix-v154.js?v=154" defer></script>');
