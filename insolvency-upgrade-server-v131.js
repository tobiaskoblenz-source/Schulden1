...
function injectInsolvencyUpgrade(body){
  ...
  if(!body.includes('/paperless-inbox-filter-v158.js')) tags.push('<script src="/paperless-inbox-filter-v158.js?v=158" defer></script>');
  ...
  if(!body.includes('/ui-fix-v158.js')) tags.push('<script src="/ui-fix-v158.js?v=158" defer></script>');
