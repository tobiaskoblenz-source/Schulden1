...
function injectInsolvencyUpgrade(body){
  ...
  if(!body.includes('/paperless-inbox-filter-v155.js')) tags.push('<script src="/paperless-inbox-filter-v155.js?v=155" defer></script>');
  ...
  if(!body.includes('/ui-fix-v155.js')) tags.push('<script src="/ui-fix-v155.js?v=155" defer></script>');
