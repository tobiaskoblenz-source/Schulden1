...
window.addEventListener('change',e=>{
  const sel=e.target?.closest?.('[data-v153-pl-select]');if(sel)sel.dataset.v156Manual='1';
},true);
...
window.v156PaperlessInboxFilter=apply;
})();
